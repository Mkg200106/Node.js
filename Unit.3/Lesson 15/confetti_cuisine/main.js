...
// Define the route to retrieve all subscribers (GET /subscribers)
app.get("/subscribers", subscribersController.getAllSubscribers, (req, res, next) => {
  // Assuming subscribersController adds the data to `req.data`
  console.log(req.data); // Log the retrieved subscribers
  res.send(req.data);    // Send the data as a response
});
